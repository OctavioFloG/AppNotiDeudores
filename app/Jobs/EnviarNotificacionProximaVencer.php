...
class EnviarNotificacionProximaVencer implements ShouldQueue
{
    ...
    {
        $fechaObjetivo = now()->addDays(3)->toDateString();
        ...
        CuentaPorCobrar::whereDate('fecha_vencimiento', $fechaObjetivo)
            ...
            ->chunkById(100, function ($deudas) use ($whatsurvey) {
                foreach ($deudas as $deuda) {
                    ...
                    $mensaje .= "Le recordamos que tiene una deuda próxima a vencer.\n";
                    $mensaje .= "Monto: \${$monto}\n";
                    ...
                    try {
                        ...
                        Notificacion::create([
                            ...
                            'tipo'           => 'proxima_vencer',
                            'canal'          => 'whatsapp',
                            'asunto'         => 'Recordatorio de deuda próxima a vencer',
                            'mensaje'        => $mensaje,
                        ...
                        if (!$resp['success']) {
                            Log::warning('Whatsurvey fallo próxima a vencer', [
                        ...
                        Log::error('Error job próxima a vencer', [
                            'deuda_id' => $deuda->id_cuenta,
                            'error'    => $e->getMessage(),
                        ]);
                    }
